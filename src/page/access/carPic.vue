...
<template>
  <div>
    ...
    <div class="bg-white">
      <span class="tit-tag ml10 lh40 ft16 fw-b">请上传清晰证件<span class="cl-gray ft12 fw-n">（资料越完整报价越快）</span></span>
      <div class="ml10 mt10">
    ...
    <div class="h30 mt5">
      <div class="lh30 fr cl-primary mr10" @click="goSample">不会拍？查看示例图</div>
    </div>
    <div class="h70">
